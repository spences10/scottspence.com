...
export const GET = async ({ url }) => {
	...
	try {
		...
		console.warn('Database unavailable, returning empty related posts:', error instanceof Error ? error.message : 'Unknown error')
		// Return empty related posts when database is down
		return json({ related_posts: [] })
	}
}
