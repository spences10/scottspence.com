...
<footer
  class="bg-primary relative inset-0"
  aria-labelledby="footerHeading"
>
  <h3 id="footerHeading" class="sr-only">Footer</h3>
  <div class="mx-auto px-4 py-12 max-w-full sm:px-6 lg:px-8 lg:py-16">
    <div class="xl:grid xl:gap-8 xl:grid-cols-2">
      <div class="space-y-8 xl:col-span-1">
        ...
        <p class="text-left text-base">
          Built with SvelteKit, MDSveX and Tailwind
        </p>
        <p class="text-left text-base">
        ...
        <div class="flex space-x-6">
          ...
          >
            ...
            <svg
              ...
              height="20"
              width="20"
              class="hover:text-accent fill-current"
            >
              <path
      ...
      <div class="grid gap-8 grid-cols-1 mt-12 xl:col-span-1 xl:mt-0">
        <div class="md:grid md:gap-8 md:grid-cols-2">
          <div>
            <h3
              class="mb-3 text-lg font-semibold tracking-wider uppercase"
            >
              Popular posts
            </h3>
    ...
    <div class="mt-12 pt-8 border-t border-gray-200">
      <p class="mb-12 text-base lg:mb-0 xl:text-center">
