...
Migrate from Fathom API to self-hosted analytics using `analytics_events` table.

## Timeline

- **End of 2025**: Export Fathom 2025 data, update analytics_* tables
- **Jan 1 2026**: Start using local analytics exclusively, daily rollups
...
3. Historical data: keep analytics_pages etc. or migrate to new schema?
...
- `src/routes/api/ingest/rollup-analytics.ts`
- `src/routes/api/ingest/flag-bot-behaviour.ts`
- `src/routes/api/ingest/cleanup-analytics.ts`
- `src/lib/analytics/track.server.ts`
